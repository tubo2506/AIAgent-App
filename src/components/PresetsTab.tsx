...
export const PRESETS: PresetItem[] = [
  ...
  },
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.2 },
  },
  {
  ...
  // --- 2. MARKETING, NỘI DUNG & BÁN HÀNG ---
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.7 },
  },
  {
    id: 'mkt_aida_copy',
  ...
  },
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.5 },
  },
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.6 },
  },
  ...
  // --- 4. QUẢN TRỊ & NĂNG SUẤT VĂN PHÒNG ---
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.3 },
  },
  {
    ...
    config: { model: 'gemini-3.5-flash-lite', streaming: true, temperature: 0.4 },
  },
  {
    id: 'biz_kpi_okr',
                ...
                >
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1.5 text-[10px] font-mono text-slate-500 dark:text-slate-400">
                      ...
                      <span>{preset.config.model || 'gemini-3.5-flash-lite'}</span>
                    </div>
